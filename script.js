...
function easeToward(
    ...
    cell.offsetX +=
        (targetX - cell.offsetX) *
        ease;

    cell.offsetY +=
        (targetY - cell.offsetY) *
        ease;
}
...
function drawAscii() {
    ...
    for (const cell of asciiCells) {
        ...
        const x =
            (cell.col + cell.offsetX) *
            CELL_STEP +
            CELL_SIZE / 2;

        const y =
            (cell.row + cell.offsetY) *
            CELL_STEP;
